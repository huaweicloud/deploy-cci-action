...
const image = __importStar(require("./image-update"));
const deploy = __importStar(require("./deploy-cci"));
const cci = __importStar(require("./cci/cciService"));
function run() {
