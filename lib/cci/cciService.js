...
exports.getCCINetwork = exports.getCCINetworkSubnetID = exports.applyIngress = exports.applyService = exports.applyDeployment = exports.applyNetwork = exports.applyNamespace = exports.isDeploymentExist = exports.isNamespaceExist = exports.createDeployment = exports.createNamespace = exports.getAvailableZone = void 0;
...
function createNamespace(inputs) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!isNamespaceExist(inputs.namespace)) {
            ...
            let namespaceContent = new Namespace_1.Namespace(inputs.namespace);
            fs.writeFileSync(namespaceFileName, yaml_1.default.stringify(namespaceContent), 'utf8');
            applyNamespace(namespaceFileName);
            // 新建Network
            const securityGroupId = yield vpc.listDefaultCCISecurityGroups();
            const domainId = yield iam.keystoneListAuthDomains();
            const availableZone = getAvailableZone(inputs.region);
            const networkFileName = 'network-' + utils.getRandomByDigit(8) + '.yml';
            const vpcId = yield vpc.createVpc();
            const subnetInfo = yield vpc.createSubnet(vpcId);
            let networkContent = new Network_1.Network(inputs.namespace, securityGroupId, domainId, inputs.projectId, availableZone, subnetInfo.cidr, vpcId, subnetInfo.neutron_network_id, subnetInfo.neutron_subnet_id);
...
function createDeployment(inputs) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let deployContent = new Deployment_1.Deployment(inputs);
        ...
        // 新建vip
        const publicipId = yield eip.createPublicip();
        const subnetID = yield getCCINetworkSubnetID(inputs);
        const loadbalancer = yield elb.createLoadbalancer(subnetID);
        const vipPortId = yield elb.getLoadbalancerVipPortIdByLoadbalancer(loadbalancer);
        yield eip.updatePublicip(publicipId, vipPortId);
        // 新建Service
        ...
        let serviceContent = new Service_1.Service(inputs, elbId);
        ...
        let ingressContent = new Ingress_1.Ingress(inputs, elbId);
