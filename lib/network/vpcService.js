...
const VpcClient_1 = require("@huaweicloud/huaweicloud-sdk-vpc/v3/VpcClient");
const ListSecurityGroupsRequest_1 = require("@huaweicloud/huaweicloud-sdk-vpc/v3/model/ListSecurityGroupsRequest");
/**
 * 查询某租户下默认的安全组列表
 * @param
 * @returns
 */
function listDefaultCCISecurityGroups() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const client = VpcClient_1.VpcClient.newBuilder()
            .withCredential(credentials)
            .withEndpoint(endpoint)
            .build();
        const request = new ListSecurityGroupsRequest_1.ListSecurityGroupsRequest();
