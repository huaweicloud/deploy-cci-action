...
let Mime = __nccwpck_require__(38);
module.exports = new Mime(__nccwpck_require__(114), __nccwpck_require__(809));
...
const context = __importStar(__nccwpck_require__(970));
...
const context = __importStar(__nccwpck_require__(970));
const install = __importStar(__nccwpck_require__(565));
const auth = __importStar(__nccwpck_require__(649));
const image = __importStar(__nccwpck_require__(477));
const deploy = __importStar(__nccwpck_require__(15));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        const inputs = context.getInputs();
        //如果参数输入有问题，终止操作
...
const fs = __importStar(__nccwpck_require__(147));
const path = __importStar(__nccwpck_require__(17));
const mime = __importStar(__nccwpck_require__(994));
/**
