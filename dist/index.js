...
/***/ (function(__unused_webpack_module, exports, __nccwpck_require__) {
    ...
    function configCciAuth() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (cp.execSync(`cci-iam-authenticator generate-kubeconfig --cci-endpoint=https://cci.${input.region}.myhuaweicloud.com --ak=${input.accessKey} --sk=${input.secretKey}`) || '').toString();
        });
    }
    ...
    function deployCCI() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (cp.execSync(`kubectl apply -f ${inputs.manifest}`) || '').toString();
        });
    }
    ...
    Object.defineProperty(exports, "__esModule", ({ value: true }));
    exports.getImageArray = exports.replaceMatchingFileContent = exports.updateImage = void 0;
    const core = __importStar(__nccwpck_require__(423));
    const fs = __importStar(__nccwpck_require__(147));
    const path = __importStar(__nccwpck_require__(17));
    /*
    ...
    function updateImage(inputs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield replaceMatchingFileContent(imageArray, manifestPath);
        });
    }
    ...
    Object.defineProperty(exports, "__esModule", ({ value: true }));
    exports.installCciIamAuthenticator = exports.getAuthDownloadURL = exports.installCciIamAuthenticatorByPlatform = exports.downloadCciIamAuthenticator = void 0;
    const core = __importStar(__nccwpck_require__(423));
    const os = __importStar(__nccwpck_require__(37));
    const cp = __importStar(__nccwpck_require__(81));
