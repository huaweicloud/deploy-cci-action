...
export class CreateLoadbalancerRequestBody {
    ...
    public withLoadbalancer(loadbalancer: CreateLoadbalancerLoadbalancerOption): CreateLoadbalancerRequestBody {
        this['loadbalancer'] = loadbalancer;
        return this;
    }
    public set _loadbalancer(loadbalancer: CreateLoadbalancerLoadbalancerOption | undefined) {
        this['loadbalancer'] = loadbalancer;
    }
