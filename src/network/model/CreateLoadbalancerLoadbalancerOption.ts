export class CreateLoadbalancerLoadbalancerOption {
    ...
    public withTenantId(tenantId: string): CreateLoadbalancerLoadbalancerOption {
    ...
    public withName(name: string): CreateLoadbalancerLoadbalancerOption {
        this['name'] = name;
        return this;
    }
    ...
    public withDescription(description: string): CreateLoadbalancerLoadbalancerOption {
    ...
    public withVipSubnetId(vipSubnetId: string): CreateLoadbalancerLoadbalancerOption {
        this['vip_subnet_id'] = vipSubnetId;
        return this;
    }
    ...
    public withVipAddress(vipAddress: string): CreateLoadbalancerLoadbalancerOption {
    ...
    public withProvider(provider: string): CreateLoadbalancerLoadbalancerOption {
    ...
    public withAdminStateUp(adminStateUp: string): CreateLoadbalancerLoadbalancerOption {
    ...
    public withEnterpriseProjectId(enterpriseProjectId: string): CreateLoadbalancerLoadbalancerOption {
    ...
    public get enterpriseProjectId() {
     ...
     public withVipPortId(vipPortId: string): CreateLoadbalancerLoadbalancerOption {
