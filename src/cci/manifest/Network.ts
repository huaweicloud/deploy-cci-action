export class Network {
    ...
    metadata: Metadata;
    spec: Spec;
    constructor(networkName: string, securityGroupId: string, domainId: string, projectId: string, availableZone: string, cidr: string, attachedVPC: string, networkID: string, subnetID: string) {
...
export class Spec {
    ...
    subnetID: string;
    constructor(availableZone: string, cidr: string, attachedVPC: string, networkID: string, subnetID: string) {
