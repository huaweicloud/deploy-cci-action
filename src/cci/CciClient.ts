...
export class CciClient {
     ...
     */
    public listNetworkingCciIoV1beta1NamespacedNetwork(listNetworkingCciIoV1beta1NamespacedNetworkRequest?: ListNetworkingCciIoV1beta1NamespacedNetworkRequest): Promise<ListNetworkingCciIoV1beta1NamespacedNetworkResponse> {
        const options = ParamCreater().listNetworkingCciIoV1beta1NamespacedNetwork(listNetworkingCciIoV1beta1NamespacedNetworkRequest);
...
export const ParamCreater = function () {
    return {
        ...
        listNetworkingCciIoV1beta1NamespacedNetwork(listNetworkingCciIoV1beta1NamespacedNetworkRequest?: ListNetworkingCciIoV1beta1NamespacedNetworkRequest) {
            ...
            if (listNetworkingCciIoV1beta1NamespacedNetworkRequest !== null && listNetworkingCciIoV1beta1NamespacedNetworkRequest !== undefined) {
                if (listNetworkingCciIoV1beta1NamespacedNetworkRequest instanceof ListNetworkingCciIoV1beta1NamespacedNetworkRequest) {
                    namespace = listNetworkingCciIoV1beta1NamespacedNetworkRequest.namespace;
                } else {
                    namespace = listNetworkingCciIoV1beta1NamespacedNetworkRequest['namespace'];
                }
            }
