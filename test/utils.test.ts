...
describe('test get endpoint ', () => {
  const testCase = [
    {region: 'cn-north-4', service: EndpointServiceName.CCI, result: 'https://cci.cn-north-4.myhuaweicloud.com'},
    {region: 'cn-north-4', service: EndpointServiceName.ELB, result: 'https://elb.cn-north-4.myhuaweicloud.com'},
    {region: 'cn-north-4', service: EndpointServiceName.IAM, result: 'https://iam.cn-north-4.myhuaweicloud.com'},
    {region: 'cn-north-4', service: EndpointServiceName.VPC, result: 'https://vpc.cn-north-4.myhuaweicloud.com'},
  ];
  testCase.forEach(item => {
