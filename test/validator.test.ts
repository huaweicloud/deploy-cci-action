...
describe('test whether the aksk parameter is valid', () => {
    const testCase = [
        { accessKey: '1234567890', secretKey: '123456789012345678901234567890', result: true},
        ...
        { accessKey: '12345', secretKey: '123456789012345678901234567890', result: false},
        { accessKey: '1234567890', secretKey: '1234567890', result: false},
        { accessKey: '1234567890123456789012345678901', secretKey: '123456789012345678901234567890123456789012345678901', result: false},
        { accessKey: '1234567890123456789012345678901', secretKey: '123456789012345678901234567890', result: false},
        { accessKey: '1234567890', secretKey: '123456789012345678901234567890123456789012345678901', result: false},
        { accessKey: '1234%^890', secretKey: '1234567890123456#$12345678901234567890', result: false},
    ]
...
describe('test whether the projectId parameter is valid', () => {
    const testCase = [
        ...
        { projectId: '12345678901234567890123456789012345678901234567890123456789012345', result: false},
...
describe('test whether the namespace parameter is valid', () => {
    const testCase = [
        ...
        { namespace: 'dd-123456789012345678901234567890123456789012345678901234567890d', result: false},
    ]
    testCase.forEach(item => {
...
describe('test whether the deployment parameter is valid', () => {
    const testCase = [
        ...
        { deployment: 'dd-.fd3', result: false},
        { deployment: 'dd..fd3', result: false},
        { deployment: 'dd-123456789012345678901234567890123456789012345678901234567890d', result: false},
    ]
    testCase.forEach(item => {
